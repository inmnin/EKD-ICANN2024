...
In this experiment, we adopt the base teacher model weights from bert-base-chinese (*https://huggingface.co/bert-base-chinese/tree/main*), and fine-tune them on each dataset independently.
